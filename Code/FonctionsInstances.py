...
def generateRandomInstances(n,k):
    ...
    #on place les doubles murs. On en place 1 pour 1 sous-ensemble de carré de 4 cellules sur deux 
    #(sans compter les lignes et colonnes du bord)
    ...
    #on place k robots au hasard (noté 1,2,...,k), mais pas dans l'ilot central. Le robot 1 sera le robot devant 
    #atteindre la cible but.
